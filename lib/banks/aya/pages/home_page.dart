...
import 'package:auto_report/banks/aya/data/account/accounts.dart';
...
import 'package:auto_report/banks/aya/pages/accounts_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void newAccount({
    ...
    final result =
        await Navigator.of(context).pushNamed("/aya/auth", arguments: {
